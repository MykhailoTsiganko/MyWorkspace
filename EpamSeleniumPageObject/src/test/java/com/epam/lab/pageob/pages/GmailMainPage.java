...
public class GmailMainPage {
    ...
    public static final String IMPORTANT_MESSAGE_CLASS = "pH-A7 a9q";
	...
	topEditMenu = new EditMenu(driver);
    }
	...
	int markedNumber = 0;
	for (WebElement element : messagesBox) {
	    if (element.findElement(By.xpath(MESSAGE_IMPORTENCE_VALUE_XPATH)).getAttribute("class")
		    .equals(IMPORTANT_MESSAGE_CLASS)) {
    ...
    public GmailMainPage markMessagesByModels(List<Message> messageModelList) {
	...
	for (WebElement element : messagesBox) {
		...
		WebElement checkBox = element.findElement(By.xpath(CHECKBOX_XPATH));
