...
public class GmailLoginPage {
	...
	submitButton.actionClick();
    }

    private void waitForLoad() {
	new WebDriverWait(DriverSingltone.getInstance(), 30).until((ExpectedCondition<Boolean>) wd -> ((JavascriptExecutor) wd).executeScript("return document.readyState").equals("complete"));
    }
}
